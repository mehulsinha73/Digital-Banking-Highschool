...
public class FTCompleteListener implements ActionListener {
	...
	public FTCompleteListener(JPanel loginSuccPanel,JTextField benificiary,JTextField amount,JComboBox<String> accountList,JLabel errMsg) {
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if(result){
    		...
    		JLabel message=new JLabel("Funds Transfer has been completed successfully");
    		...
    		lblAccountList.setBounds(140, 135,190, 20);
